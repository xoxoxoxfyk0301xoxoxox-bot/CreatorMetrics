...
export interface ThreadsPerformanceRecord { contentId:string; views:number; likes:number; replies:number; reposts:number; quality:"OK"|"PARTIAL"|"INSUFFICIENT_BASELINE"|"NO_DATA"; periodStart:string; periodEnd:string }
